    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (operation.equals("=")) {
                ...
                System.out.println(input1 + " " + operation + " " + input2 + " = " + result);
                continue;
            ...
            if (output.getDenominator() == 1) {
                ...
                System.out.println(input1 + " " + operation + " " + input2 + " = " + outInt);
                continue;
            }

            System.out.println(input1 + " " + operation + " " + input2 + " = " + output);
        }
    }
